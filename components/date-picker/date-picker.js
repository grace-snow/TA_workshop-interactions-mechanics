...
const DatePicker = ({ numMonthsAheadToStart = 2 }) => {
  ...
  // DatePicker Roving Tabindex functionality
  ...
  const handleKeyUp = (event) => {
    ...
    if (event.key === "ArrowRight") {
      ...
      let prevDayNum = buttonDateIndex - 1;
      ...
      let prevWeekNum = buttonDateIndex - 7;
    ...
    <div className='date-picker'>
              ...
              {week.map((day, index) => (
                <td key={index}>
                  <button
                    ...
                    aria-label={`${dayjs(day.date).format("D MMMM, dddd")}${
      ...
      <HeaderPortal>
        <dialog
          ...
          <h1 id='dialogHeading' ref={dialogHeadingRef} tabIndex='-1'>
            Confirm selection
          </h1>
          ...
          <div className='form-submit'>
            <button className='btn-submit' onClick={hideConfirmModal}>
              Accept
            </button>
          </div>
        </dialog>
